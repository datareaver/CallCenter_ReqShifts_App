...
shinyUI(fluidPage(
    ...
    titlePanel("Staff Scheduling Optimization"),
    ...
    tabsetPanel(
        ...
        tabPanel('Inputs',
            ...
            wellPanel( 
                ...
                fixedRow(
                fileInput('file', h4('Choose CSV File containing Hourly Load:'),
                      accept=c('text/csv', 
                               'text/comma-separated-values,text/plain', 
                               '.csv')),
                       
                    checkboxGroupInput("shift.length", label = h4("Shift Lengths:"),
                                choices = c(4,5,6,7,8,9,10,11,12), selected = 8),
                       
                h4('Shift Start Times:'),
                
                column(1,
                       
                       checkboxGroupInput('start1', label = h5('Sunday'),
                ...
                column(1,offset = .9,
                       ...
                       checkboxGroupInput('start2', label = h5('Monday'),
                ...
                fixedRow(
                    column(1, offset = 2,
                           ...
                           h3('Scheduled Capacity vs. Offered Load'),
                           plotOutput('loadplot',width = 800, height = 600),
                           br(),
                           p(textOutput('loadtext'))
